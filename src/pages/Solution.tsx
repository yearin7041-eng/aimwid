...
const Hero = () => (
  <section className="relative overflow-hidden bg-[#040813] lg:min-h-[820px]">
    ...
    <div className="relative pt-[64px] lg:pt-0 lg:absolute lg:inset-0 pointer-events-none">
      {/* Mobile/tablet: the subject-centred crop (solution_hero_v3_m) so the lineup sits dead-centre with
          the radial fade — the full still is right-heavy and read off-centre when centred. */}
      <img
        src={asset("solution_hero_v3_m.webp")}
        alt="에너지, 스마트시티, 안전 분야의 산업 AI 솔루션 라인업"
        className="lg:hidden mx-auto block h-[200px] w-auto max-w-full"
        style={{
          WebkitMaskImage:
            "linear-gradient(to right, transparent 0%, #000 18%, #000 82%, transparent 100%), linear-gradient(to bottom, transparent 0%, #000 18%, #000 82%, transparent 100%)",
          maskImage:
            "linear-gradient(to right, transparent 0%, #000 18%, #000 82%, transparent 100%), linear-gradient(to bottom, transparent 0%, #000 18%, #000 82%, transparent 100%)",
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="hidden lg:block absolute right-0 top-1/2 h-[104%] w-auto max-w-none -translate-y-1/2 object-contain"
      />
    ...
    <div className="container-custom relative z-10 pt-8 lg:pt-[200px] pb-[120px]">
      ...
      >
        ...
        <p className="text-[#90a1b9] text-[14px] md:text-[20px] font-bold leading-[1.4] mb-2 md:mb-4">Industry AI Solutions</p>
